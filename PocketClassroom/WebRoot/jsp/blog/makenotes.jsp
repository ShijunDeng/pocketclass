...
<body id="container" >
	...
	<div id="d1">
		...
		<div id="right">
			<div>
				<form action="${pageContext.request.contextPath}/servlet/PublishNotesServlet" method="post" onsubmit="return checkForm(this)">
